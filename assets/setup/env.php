...
if (!defined('APP_NAME'))                       define('APP_NAME', 'WEBWISE');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'E Commerce');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'devaicee');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', 'WebWise PHP Login System');

if (!defined('ALLOWED_INACTIVITY_TIME'))        define('ALLOWED_INACTIVITY_TIME', time()+1*60);

if (!defined('DB_DATABASE'))                    define('DB_DATABASE', 'webwise_loginsystem');
